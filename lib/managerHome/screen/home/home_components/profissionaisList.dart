...
class ProfissionaisListProfView extends StatefulWidget {
  final double widhScreen;
  final double heighScreen;
  const ProfissionaisListProfView({
    super.key,
  ...
  @override
  State<ProfissionaisListProfView> createState() =>
      _ProfissionaisListProfViewState();
}

class _ProfissionaisListProfViewState extends State<ProfissionaisListProfView> {
  @override
